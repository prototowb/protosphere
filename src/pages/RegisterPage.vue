    ...
    <div class="w-full max-w-md rounded-lg bg-bg-secondary p-8">
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        ...
        <div>
          ...
          />
          <p v-if="username && !usernameValid" class="mt-1 text-xs text-red-400">
        ...
        <div>
          <label for="confirm-password" class="mb-1 block text-sm text-text-secondary">Confirm Password</label>
          <input
            id="confirm-password"
