...
| **Production** | main project | CI secrets | Live site |
...
3. Smoke-test against staging (`npm run dev` with `.env.staging`)
4. Only then apply to production via Supabase dashboard → SQL editor or production project CLI link
